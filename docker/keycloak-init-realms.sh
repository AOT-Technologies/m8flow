...
# Run after Keycloak is up; realms master and m8flow must exist
# (master is built-in; m8flow is imported via --import-realm).
...
echo "[keycloak-init-realms] Setting sslRequired=NONE on realms master, m8flow..."
