"""m8flow compatibility shim for spiffworkflow_backend.models.kkv_data_store.
...
Kept so that existing `from m8flow_backend.models.kkv_data_store import ...` imports keep
working. New code should import from spiffworkflow_backend.models.kkv_data_store directly.
...
from spiffworkflow_backend.models.kkv_data_store import (  # noqa: F401
    KKVDataStoreModel,
)
