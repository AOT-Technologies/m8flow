"""m8flow compatibility shim for spiffworkflow_backend.models.message_model.
...
Kept so that existing `from m8flow_backend.models.message_model import ...` imports keep
working. New code should import from spiffworkflow_backend.models.message_model directly.
...
from spiffworkflow_backend.models.message_model import (  # noqa: F401
    MessageModel,
