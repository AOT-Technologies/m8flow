"""m8flow compatibility shim for spiffworkflow_backend.models.process_instance_error_detail.
...
Kept so that existing `from m8flow_backend.models.process_instance_error_detail import ...` imports keep
working. New code should import from spiffworkflow_backend.models.process_instance_error_detail directly.
