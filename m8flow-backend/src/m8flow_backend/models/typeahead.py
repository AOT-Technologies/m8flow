"""m8flow compatibility shim for spiffworkflow_backend.models.typeahead.
...
Kept so that existing `from m8flow_backend.models.typeahead import ...` imports keep
working. New code should import from spiffworkflow_backend.models.typeahead directly.
...
from spiffworkflow_backend.models.typeahead import (  # noqa: F401
    TypeaheadModel,
)
