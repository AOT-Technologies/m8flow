"""m8flow compatibility shim for spiffworkflow_backend.models.task.
...
Kept so that existing `from m8flow_backend.models.task import ...` imports keep
working. New code should import from spiffworkflow_backend.models.task directly.
