"""m8flow compatibility shim for spiffworkflow_backend.models.permission_target.
...
Kept so that existing `from m8flow_backend.models.permission_target import ...` imports keep
working. New code should import from spiffworkflow_backend.models.permission_target directly.
...
from spiffworkflow_backend.models.permission_target import (  # noqa: F401
