"""m8flow compatibility shim for spiffworkflow_backend.models.message_instance_correlation.
...
Kept so that existing `from m8flow_backend.models.message_instance_correlation import ...` imports keep
working. New code should import from spiffworkflow_backend.models.message_instance_correlation directly.
