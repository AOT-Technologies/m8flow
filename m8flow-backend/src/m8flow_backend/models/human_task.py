"""m8flow compatibility shim for spiffworkflow_backend.models.human_task.
...
Kept so that existing `from m8flow_backend.models.human_task import ...` imports keep
working. New code should import from spiffworkflow_backend.models.human_task directly.
...
from spiffworkflow_backend.models.human_task import (  # noqa: F401
    HumanTaskModel,
)
