"""m8flow compatibility shim for spiffworkflow_backend.models.process_instance_event.
...
Kept so that existing `from m8flow_backend.models.process_instance_event import ...` imports keep
working. New code should import from spiffworkflow_backend.models.process_instance_event directly.
...
from spiffworkflow_backend.models.process_instance_event import (  # noqa: F401
